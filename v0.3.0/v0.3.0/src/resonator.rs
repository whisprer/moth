...
use crate::dsp_core::{soft_saturate, DcBlocker};
    ...
    pub fn process(&mut self, input: &[f32], output: &mut [f32]) {
        ...
        for i in 0..len {
            ...
            for m in 0..NUM_MODES {
                ...
                let wobble = 1.0 + lfo * 0.0008 * self.dna.stereo_offset * (1.0 + m as f32 * 0.1);
...
mod tests {
    ...
    fn fast_cos_reasonable_accuracy() {
        ...
        let cases = [(0.0, 1.0), (PI * 0.5, 0.0), (PI, -1.0), (PI * 1.5, 0.0)];
