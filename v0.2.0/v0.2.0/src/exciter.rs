...
impl ExciterModel {
    ...
    pub fn lerp(self, other: Self, t: f32) -> Self {
        ...
        let mult_f = self.multiplicity as f32
            + (other.multiplicity as f32 - self.multiplicity as f32) * t;
...
mod tests {
    ...
    fn all_presets_in_range() {
        ...
        for (name, preset) in &presets {
            ...
            assert!(preset.multiplicity >= 1, "{name}: multiplicity must be >= 1");
        }
    }
    ...
    fn coupling_axes_independent() {
        ...
        assert!(cl.total_coupling() > 1.0, "Hybrid coupling should exceed 1.0");
